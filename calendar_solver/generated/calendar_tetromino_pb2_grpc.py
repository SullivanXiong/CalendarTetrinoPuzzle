...
import calendar_solver.generated.calendar_tetromino_pb2 as calendar__tetromino__pb2
import grpc
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in calendar_tetromino_pb2_grpc.py depends on'
...
def add_TetrominoSolverServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SolvePuzzle': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=calendar__tetromino__pb2.PuzzleRequest.FromString,
                    response_serializer=calendar__tetromino__pb2.PuzzleSolution.SerializeToString,
            ),
            'SolvePuzzleAllSolutions': grpc.unary_unary_rpc_method_handler(
                    servicer.SolvePuzzleAllSolutions,
                    request_deserializer=calendar__tetromino__pb2.PuzzleRequest.FromString,
                    response_serializer=calendar__tetromino__pb2.PuzzleSolutions.SerializeToString,
            ),
    }
